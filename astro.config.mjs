          ...
          items: [
            { label: '스터디장 공간', slug: 'study-leader' },
            {
              ...
              items: [
                ...
                { label: '20260724', slug: 'study-leader/daily-news/20260724' },
                { label: '20260729', slug: 'study-leader/daily-news/20260729' },
                { label: '20260731', slug: 'study-leader/daily-news/20260731' },
              ],
            },
            {
              label: '경제잡지',
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: '김요욱', slug: 'gen-4/week-08-2026-07-23/kim-yowook' },
                ...
                { label: '정나현2', slug: 'gen-4/week-08-2026-07-23/jung-nahyun-2' },
                {
                  label: '송하영',
                  slug: 'gen-4/week-08-2026-07-23/song-hayoung/clarity-act-digital-dollar',
                },
                { label: '심소연', slug: 'gen-4/week-08-2026-07-23/shim-soyeon' },
