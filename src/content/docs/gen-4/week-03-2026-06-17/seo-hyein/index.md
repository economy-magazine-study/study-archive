...
_(한경비즈니스 2026.06.10-16 / 최수진 기자 · 박병창 교보증권 이사 분석·인터뷰)_
...
| 최대 위험           | 물가·금리      | 상승 엔진을 멈출 수 있는 브레이크     |
...
- 핵심 우려 = **물가와 금리**
  ...
  - AI 열풍이 반도체·에너지 수요 자극 → 새 인플레 압력 (데이터센터 건설, 막대한 유동성 정책이 하반기 물가 상승 요인)
...
- 하반기 최대 우려 = **물가 상승으로 인한 글로벌 기준금리 인상 기조**
